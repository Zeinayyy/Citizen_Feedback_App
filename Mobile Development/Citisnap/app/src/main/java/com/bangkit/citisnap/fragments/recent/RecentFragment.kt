...
import com.bangkit.citisnap.databinding.FragmentRecentBinding
...
class RecentFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val viewModelFactory = RecentViewModelFactory(repository)
        val viewModel = ViewModelProvider(this, viewModelFactory)[RecentViewModel::class.java]
    ...
    private fun getData(viewModel: RecentViewModel) {
